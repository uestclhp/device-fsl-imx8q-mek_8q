        ...
        switch (propValue.prop) {
            ...
            case AP_POWER_STATE_REPORT:
                switch (propValue.value.int32Values[0]) {
                    case toInt(VehicleApPowerStateReport::BOOT_COMPLETE):
                          ALOGI("VehicleHal VehicleApPowerStateReport BOOT_COMPLETE");
                          break;
                    case toInt(VehicleApPowerStateReport::DEEP_SLEEP_EXIT):
                          ALOGI("VehicleHal VehicleApPowerStateReport  DEEP_SLEEP_EXIT");
                          break;
                    case toInt(VehicleApPowerStateReport::DEEP_SLEEP_ENTRY):
                          ALOGI("VehicleHal  VehicleApPowerStateReport DEEP_SLEEP_ENTRY");
                          break;
                    case toInt(VehicleApPowerStateReport::SHUTDOWN_POSTPONE):
                          ALOGI("VehicleHal VehicleApPowerStateReport  SHUTDOWN_POSTPONE");
                          break;
                    case toInt(VehicleApPowerStateReport::SHUTDOWN_START):
                          ALOGI("VehicleHal VehicleApPowerStateReport SHUTDOWN_START");
                          break;
                    case toInt(VehicleApPowerStateReport::DISPLAY_OFF):
                          ALOGI("VehicleHal VehicleApPowerStateReport DISPLAY_OFF");
                          break;
                    case toInt(VehicleApPowerStateReport::DISPLAY_ON):
                          ALOGI("VehicleHal VehicleApPowerStateReport DISPLAY_ON");
                          break;
                    default:
                          ALOGI("VehicleHal VehicleApPowerStateReport Unkown State");
                        break;
                }
                return StatusCode::OK;
                break;
            case AP_POWER_STATE_REQ:
                switch (propValue.value.int32Values[0]) {
                    case toInt(VehicleApPowerStateReq::ON_DISP_OFF):
                          ALOGI("VehicleHal AP_POWER_STATE_REQ :ON_DISP_OFF");
                          doHalEvent(createApPowerStateReq(VehicleApPowerStateReq::ON_DISP_OFF, 0));
                          break;
                    case toInt(VehicleApPowerStateReq::ON_FULL):
                          ALOGI("VehicleHal  AP_POWER_STATE_REQ : ON_FULL");
                          doHalEvent(createApPowerStateReq(VehicleApPowerStateReq::ON_FULL, 0));
                          break;
                    default :
                          ALOGI("VehicleHal AP_POWER_STATE_REQ : Unkown ");
                          break;
                }
                return StatusCode::OK;
                break;
